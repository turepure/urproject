...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-admin-role-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">角色英文名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="rolecode" name="rolecode" datatype="*4-16" nullmsg="用户账户不能为空">
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    $(function(){
        ...
        $("#admin-role-save").click(function(){
            ...
            $.ajax({
                url:"<?php echo U('Admin/Role/add_role');?>",
                data:add_data,
                type:'post', //GET
                cache:false,
