    ...
    <form action="<?php echo U('Admin/list/add_user');?>" method="post" class="form form-horizontal" id="form-admin-user-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="" name="uername">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>密码：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="password" name="password" datatype="*4-16" nullmsg="不能为空">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
                <button type="submit" class="btn btn-success radius" id="admin-user-save" name="admin-role-save"><i class="icon-ok"></i> 确定</button>
            </div>
        </div>
    </form>
</article>
...
//        });
        ...
        $("#admin-user-save").click(function(){
            ...
            $.ajax({
                url:"<?php echo U('Admin/list/add_user');?>",
                data:add_data,
                type:'get', //GET
                cache:false,
